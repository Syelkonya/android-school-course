package com.example.androidschoolcourse.adapters;
...
import com.example.androidschoolcourse.R;
...
public class LecturesAdapter extends RecyclerView.Adapter<LecturesAdapter.BaseViewHolder> {
    ...
    private com.example.androidschoolcourse.models.DisplayMode mDisplayMode = com.example.androidschoolcourse.models.DisplayMode.UNGROUPED;
    ...
    public void setLectures(@Nullable List<Lecture> lectures) {
        if (lectures == null) {
            ...
            switch (mDisplayMode) {
                ...
                case UNGROUPED:
                default:
                    mAdapterItems = new ArrayList<>(lectures);
            }
        }
     ...
     */
    public void setDisplayMode(@NonNull com.example.androidschoolcourse.models.DisplayMode displayMode) {
